...
```bash
tail -3 /private/tmp/claude-502/-Users-ray-shao-book-reader/c3ac6f98-aa36-4abe-b552-f2c05b2e18d6/tasks/bpi071klb.output   # 第一部部稿 part P1
...
最後一行出現 `=== [05] pipeline done` 或 `=== [P1] part done` 才算跑完。第五章已完成並 commit；第二章回頭看已重寫完成（8d07b01）；第三章回頭看已完成（567e2cd）；第一部部稿 20:35 起跑。
...
| 第七至十二章、結語 | 未寫 | | |
| 部稿 P1 | **跑中**（bpi071klb），`book-reader/book-v2/P1-第一部｜我們怎麼走到一起，又失去彼此.md` | | |
| 部稿 P2–P4 | 未寫 | | |

## 接下來要做的

**回頭看線**（只寫作者已校閱的章，追上正文就停）：P1 跑完 → 整篇讀過、修掉抽象、重述故事或後設句 → commit →（已跑：`part P1 "第一部｜我們怎麼走到一起，又失去彼此" "第一部｜我們怎麼走到一起，又失去彼此" "4,000–5,000"`）→ `reflect 04 "每年的七月三十一日" "第四章｜每年的七月三十一日" "800–1,200"` → 停，等作者校閱第五章。
